...
if __name__ == '__main__':
    ...
    s.send("19/var/mobile/Documents/com.zjx.zxtouchsp/recording/201212113603.bdl".encode())  # 13 at head means the task id is 13 (run shell command). The shell command here is "killall Prefernces", which kills the settings app.
    print(s.recv(1024))
    time.sleep(5)
    s.send("20".encode())
    s.close()
