...
device.show_toast(TOAST_SUCCESS, "Recognizing (50,200,600,600).... Supported languages: " + "".join(device.get_supported_ocr_languages(0)[1]), 15)

ocr_string_list = device.ocr((50,200,600,600), debug_image_path=DEBUG_IMAGE_PATH, recognition_level=0)
